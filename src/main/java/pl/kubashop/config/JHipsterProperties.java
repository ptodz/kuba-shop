...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "kubaShop@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "kubaShop API";

        private String description = "kubaShop API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "kubaShop";
